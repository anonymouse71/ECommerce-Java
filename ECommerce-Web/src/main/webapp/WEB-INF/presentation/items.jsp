...
<head>
    ...
    <link rel="stylesheet" href="http://cdn-acme.appdynamics.com<%= request.getContextPath() %>/css/appdynamics.css"/>
</head>
<body>
                                            ...
                                            <tr>
                                                <th height="137" colspan="2">
                                                    <div align="center"><img
                                                            src="http://cdn-acme.appdynamics.com<%= request.getContextPath() %>/images/The_Lost_City_Of_Z-David_Grann.jpg"
                                        ...
                                        <div class="Items">
                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0">
                                                ...
                                                <c:forEach var="item" items="${itemsList}" varStatus="status" step="1"
                                                    ...
                                                    <td>
                                                        <div class="itemBoxes">
                                                            <img src='http://cdn-acme.appdynamics.com<%= request.getContextPath() %>/<c:out value="${item.imagePath}"/>' alt="book1"/>
